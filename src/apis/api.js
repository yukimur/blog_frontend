...
export const create_blog = params => http.post(HOST+'/blog/blog/', params)
...
export const patch_blog = params => http.patch(HOST+'/blog/blog/%(id)d/', params)
export const delete_blog = params => http.delete(HOST+'/blog/blog/', params)
export const get_blog_detail = params => http.get(HOST+'/blog/blog/%(id)d/', params)
